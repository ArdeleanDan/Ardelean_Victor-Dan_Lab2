...
namespace Ardelean_Victor_Dan_Lab2.Data
{
    public class Ardelean_Victor_Dan_Lab2Context : DbContext
    {
        ...
        public DbSet<Ardelean_Victor_Dan_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Ardelean_Victor_Dan_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
